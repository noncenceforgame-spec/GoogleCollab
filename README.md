...
** Если хотим, ищем ДЕЙСТВИТЕЛЬНО БОЛЬШИЕ ДАННЫЕ, грузим в коллаб, сначала с теми же колонками, если есть больше, пересчитываем, несложно вроде, модель сохраняется автоматически**
